	...
	<div class="container">
					...
					<div class="about">
						...
						<br>
						 ...
						 <div class="row">
							<div class="col-md-6">
								<img src="<?php echo base_url(); ?>assets/img/section-image-1.png" alt="">
								<div class="space"></div>
							</div>
							<div class="col-md-6">
							...
							<div class="row">
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member">
										<!-- Image -->
										<img class="img-responsive" src="<?php echo base_url(); ?>assets/img/team1.jpg" alt="">
										<!-- Name -->
										<h4>Johne Doe</h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member">
										<!-- Image -->
										<img class="img-responsive" src="<?php echo base_url(); ?>assets/img/team2.jpg" alt="">
										<!-- Name -->
										<h4>Jennifer</h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member">
										<!-- Image -->
										<img class="img-responsive" src="<?php echo base_url(); ?>assets/img/team3.jpg" alt="">
										<!-- Name -->
										<h4>Christean</h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member">
										<!-- Image -->
										<img class="img-responsive" src="<?php echo base_url(); ?>assets/img/team4.jpg" alt="">
										<!-- Name -->
										<h4>Kerinele rase</h4>
